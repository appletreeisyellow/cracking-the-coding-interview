...
class FixedMultiStack:
  def __init__(self, stack_size, number_of_stacks):
    ...
    self.array = [0] * (self.stack_size * self.number_of_stacks)
...
def test_multistack():
  number_of_stacks = 3
  stack_size = 6
  s = FixedMultiStack(stack_size, number_of_stacks)
...
def test_stack_does_not_exist():
  s = FixedMultiStack(stack_size=3, number_of_stacks=1)
...
if __name__ == "__main__":
  newstack = FixedMultiStack(stack_size=2, number_of_stacks=2)
